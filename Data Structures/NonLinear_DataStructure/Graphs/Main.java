...
class Main {
  ...
  public static class Graph {
    ...
    public void addEdge(int dep, int des, int weight) {
      int numV = this.numVertices;
      if (this.adjMatrixGraph[dep][des] == 1 ) {
    ...
    private void removeEdge(int dep, int des) {
      ...
      System.out.println();
      this.adjMatrixGraph[dep][des] = 0;
      this.adjMatrixGraph[des][dep] = 0;
      this.numEdges -= 1;
    }
  
    public boolean contains(int vertex) { 
      if (this.adjMatrixGraph[vertex][vertex] >= 1 ) {
       return true;
      }
      return false;
    }
    
    public boolean hasEdge(int dep, int des) {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(graph.hasEdge(2,8));
    graph.addNode(5);
    graph.addNode(7);
    graph.addEdge(5, 7, 7);
    graph.print();
